...
<div class="content py-5 px-3 bg-gradient-navy">
    <h2>Monthly Sample Laboratory Record Reports</h2>
</div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-1 py-1 text-center">Client/Depositor</th>
                        ...
                        <tbody>
                            <?php 
                       $i = 1;
                $records = $conn->query("SELECT r.*, a.name as `serial`, i.code, concat(i.lastname,', ', i.firstname, coalesce(concat(' ', i.middlename), '')) as `sample` FROM `record_list` r inner join sample_list i on r.sample_id = i.id inner join serial_list a on r.sample_id = a.id where date_format(r.`date`, '%Y-%m') = '{$month}' order by date(r.date) asc, abs(unix_timestamp(r.date_created)) asc");
                            ...
                            <tr>
                                ...
                                <td class="px-1 py-1 align-middle">
                                    <div style="line-height:1em">
                                        <div><b><?= $row['sample'] ?></b></div>
                                        <div>Client code - <?= $row['code'] ?></div>
                                    </div>
                                </td>
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-8">
                <div style="line-height:1em">
                    ...
                    <div class="text-center font-weight-bold h5 mb-0"><large>Monthly Sample Laboratory Record Report</large></div>
...
<script>
    function print_r(){
        ...
        h.find('title').text("Monthly Laboratory Record Report - Print View")
